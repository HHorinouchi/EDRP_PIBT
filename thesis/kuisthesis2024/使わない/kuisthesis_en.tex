...
\jtitle{特別研究報告書執筆の手引}     	        % Title in Japanese
\etitle[How to Write Your Graduation Thesis]%	% Title for Abstract/TOC
	{How to Write\\Your Graduation Thesis}	% Title for title page
\jauthor{氏名}				% Author name in Japanese
\eauthor{Your Name}			        % Author name in English
\supervisor{Professor John Doe}		        % Name of your Supervisor
\date{February 10, 2021}			% Submission date
...
\bibliography{kuisthesis_en}				% Output references
...
The following style options are available to be specified in the
...
\begin{description}%{
\item[type of thesis]
Since you specified \|english| option for \|\documentclass|, 
the type of your thesis, ``Graduation Thesis'', is printed
using \|\Large\bf| font.
...
\<title\> is put in the title page.
...
\item[affiliation]
You certainly are a master course student and thus belong to 
``School of Informatics and Mathematical Science,
Faculty of Engineering, Kyoto University''.
...
must not break the thesis format specified by the Faculty.  Thus, it is
...
post your problem to the local news group \|is.misc| of the Faculty.
